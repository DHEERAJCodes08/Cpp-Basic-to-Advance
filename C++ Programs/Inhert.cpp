...
class Father :virtual Grandfather{      /* here we use Virtual Keywoard insted of Public */
   public:void show(){
      cout<<" \nI have a Bike";
   };
};
...
class Mother :virtual Grandfather{              /* here we use Virtual Keywoard insted of Public */
   public:void element(){
      cout<<"\n I have a Car";
   };
};
